...
function continueFunct() {
    ...
    if (points == 0) {
        ...
        scoringText.innerHTML = "<h2 class='about-highlight'>Really? Well at least you've got 1 correct answer</h2>"
    } else if (points == 2) {
        scoringText.innerHTML = "<h2 class='about-highlight'>Not too bad! You've got 2 correct answers</h2>"
    } else if (points == 3) {
        scoringText.innerHTML = "<h2 class='about-highlight'>Do you know me already? You've got 3 out of 4!</h2>"
    } else if (points == 4) {
